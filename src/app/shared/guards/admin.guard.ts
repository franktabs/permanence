        ...
        annonces: [
          ...
          },
          {
            ...
            recepteur: {
              ...
              sexe: 'M',
              fonction:
                "CONTROLEUR D'EXPLOITATION INFORMATIQUE ASSISTANT SENIOR",
              service: 'INFORMATIQUE',
              libAge: 'DEPARTEMENT DEVELOPPEMENT ET INTEGRATION DES LOGICIELS',
              organizationId: 287740,
              agent: true,
    ...
    let obser = this.api
      ...
      .pipe(
        map((sub) => {
          ...
          console.log("connexion sans erreur rencontré");
          if (sub) {
            ...
            this.alert.alertMaterial(
              { message: 'Erreur connexion', title: 'error' },
              7
            );
          }
  ...
  async initDB() {
    ...
    try {
      ...
      if (response.data == false) {
        ...
        response = await axios.post(this.api.URL_PARAMETERS + '/many', dataParameter);
        console.log(response.data)
      ...
      this.loader.init_data$.next(true);
    }
  }
}
